  ...
  return (
    <AuthShell>
      ...
      <div className="flex justify-between items-start border-b-[3px] border-double border-auth-ink pb-3.5 mb-5 gap-3">
        ...
        <div
          aria-hidden="true"
          className="shrink-0 mt-1 inline-block px-2.5 py-0.5 border-2 border-auth-red text-auth-red font-mono text-[10px] font-bold uppercase tracking-[0.2em] rotate-[4deg] opacity-80 whitespace-nowrap"
        >
          Authorised
        </div>
      </div>
